...
void jerasure_matrix_encode_(int *matrix,
                          char **data_ptrs, char **coding_ptrs, int size);
...
int jerasure_matrix_decode__(int k, int m, int w, 
                          int *matrix, int row_k_ones, int *erasures,
                          char **data_ptrs, char **coding_ptrs, int size);
...
int jerasure_make_decoding_matrix_(int *matrix, int *erased, 
                                  int *decoding_matrix, int *dm_ids);
...
//int *jerasure_erasures_to_erased_(int *erasures);
