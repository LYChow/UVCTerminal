...
extern int galois_single_multiply_(int a, int b);
extern int galois_single_divide(int a, int b, int w);
extern int galois_single_divide_(int a, int b);
...
extern int galois_shift_multiply_(int x, int y);
...
/* These multiply regions in w=8, w=16 and w=32.  They are much faster
   than calling galois_single_multiply.  The regions must be int word aligned. */
